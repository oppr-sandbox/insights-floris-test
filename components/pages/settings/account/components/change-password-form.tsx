...
import { ChangePasswordInput, ChangePasswordPayload, changePasswordSchema, initialValues } from "../data/schema"
...
export default function ChangePassswordForm({ tenant, token }: { tenant: string, token: string }) {

    const { isSaving, changePasswordAsync } = useAccount();
                                    ...
                                    <div className="flex gap-8">
                                        <div className="w-full">
                                            ...
                                            <ConfirmationDialog
                                                ...
                                                onActionButtonClicked={handleChangePasswordClicked}
                                            />
                                        </div>
                                    </div>
                                </form>
